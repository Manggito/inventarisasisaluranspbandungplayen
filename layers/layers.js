...
var group_TITIKAKSESSORIS = new ol.layer.Group({
                                layers: [lyr_Bangunan_Air_10,lyr_BangunanBagi_11,lyr_Bangunan_Sadap_12,lyr_Rumah_Pompa_13,],
                                fold: 'open',
                                title: 'TITIK AKSESSORIS'});
var group_TITIKKETERANGAN = new ol.layer.Group({
                                layers: [lyr_Tikungan_6,lyr_Beda_Pasangan_7,lyr_Gorong__Gorong_8,lyr_TitikPer50m_9,],
                                fold: 'open',
                                title: 'TITIK KETERANGAN'});

lyr_GoogleSatellite_0.setVisible(true);lyr_SUNGAI_1.setVisible(true);lyr_JALAN_2.setVisible(true);lyr_AREAFUNGSIONAL_3.setVisible(true);lyr_KETERANGAN_KERUSAKAN_SALURAN_4.setVisible(true);lyr_JENIS_SALURAN_5.setVisible(true);lyr_Tikungan_6.setVisible(true);lyr_Beda_Pasangan_7.setVisible(true);lyr_Gorong__Gorong_8.setVisible(true);lyr_TitikPer50m_9.setVisible(true);lyr_Bangunan_Air_10.setVisible(true);lyr_BangunanBagi_11.setVisible(true);lyr_Bangunan_Sadap_12.setVisible(true);lyr_Rumah_Pompa_13.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_SUNGAI_1,lyr_JALAN_2,lyr_AREAFUNGSIONAL_3,lyr_KETERANGAN_KERUSAKAN_SALURAN_4,lyr_JENIS_SALURAN_5,group_TITIKKETERANGAN,group_TITIKAKSESSORIS];
