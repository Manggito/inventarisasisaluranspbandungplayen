...
var group_TITIKAKSESSORIS = new ol.layer.Group({
                                layers: [lyr_Bangunan_Air_15,lyr_BangunanBagi_16,lyr_Bangunan_Sadap_17,lyr_Rumah_Pompa_18,],
                                fold: 'open',
                                title: 'TITIK AKSESSORIS'});
var group_TITIKKETERANGAN = new ol.layer.Group({
                                layers: [lyr_Tikungan_11,lyr_Beda_Pasangan_12,lyr_Gorong__Gorong_13,lyr_TitikPer50m_14,],
                                fold: 'open',
...
lyr_AREAFUNGSIONAL_6.set('fieldImages', {'Id': 'Range', 'AREA': '', 'LUAS': 'TextEdit', 'SATUAN': '', });
...
lyr_Bangunan_Sadap_17.set('fieldLabels', {'NAME': 'inline label - visible with data', 'Descriptio': 'hidden field', 'pdfmaps_ph': 'hidden field', 'X': 'inline label - visible with data', 'Y': 'inline label - visible with data', 'BUJUR': 'inline label - visible with data', 'LINTANG': 'inline label - visible with data', 'PANJANG': 'inline label - visible with data', 'FOTO_1': 'no label', 'FOTO_2': 'no label', 'FOTO_3': 'no label', 'FOTO_4': 'no label', 'FOTO_5': 'no label', 'FOTO_6': 'no label', 'FOTO_7': 'no label', 'FOTO_8': 'no label', });
lyr_Rumah_Pompa_18.set('fieldLabels', {'NAME': 'inline label - visible with data', 'Descriptio': 'hidden field', 'pdfmaps_ph': 'hidden field', 'X': 'inline label - visible with data', 'Y': 'inline label - visible with data', 'BUJUR': 'inline label - visible with data', 'LINTANG': 'inline label - visible with data', 'PANJANG': 'inline label - visible with data', 'FOTO_1': 'inline label - visible with data', 'FOTO_2': 'inline label - visible with data', 'FOTO_3': 'inline label - visible with data', 'FOTO_4': 'inline label - visible with data', 'FOTO_5': 'inline label - visible with data', 'FOTO_6': 'inline label - visible with data', 'FOTO_7': 'inline label - visible with data', 'FOTO_8': 'inline label - visible with data', });
